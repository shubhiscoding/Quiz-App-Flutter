...
import 'dart:convert';
import '../Class/question.dart'; // Ensure this is your Question model
...
class _QuizScreenState extends State<QuizScreen> {
    ...
    return showDialog(
      ...
      builder: (BuildContext context) {
        ...
        final scorePercentage = (totalQuestions > 0)
            ...
            : 0;
        final roundedScorePercentage =
            double.parse(scorePercentage.toStringAsFixed(2)).toInt();
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              Text('Percentage: $roundedScorePercentage%'),
            ],
          ),
          actions: <Widget>[
            TextButton(
  ...
  Future<void> _endGame() async {
    ...
    final roundedGamePoints =
        double.parse(gamePoints.toStringAsFixed(2)).toInt();
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception(
            'Failed to end game ' + response.body + ' ' + _gameId.toString());
      }
    } catch (error) {
      print(error);
    }
